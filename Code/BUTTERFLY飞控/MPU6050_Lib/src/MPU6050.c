...
//以下这两个变量由启天的工程师在出厂时调试完成
//前后偏差，减小这个值向后偏
#define roll_ang_off_ByINSPAIRE  0
//左右检查，加大下面的值会向左偏
#define pitch_ang_off_ByINSPAIRE  0//初始时固定偏移
...
//	float temp;
	...
	**/
    ...
    /*
	  ...
	  w_and_angle.angle_roll = Roll+roll_angel_offset+roll_ang_off_ByINSPAIRE; 		//横滚角度
		w_and_angle.angle_pitch = Pitch+pitch_angel_offset+pitch_ang_off_ByINSPAIRE;	//俯仰角度
